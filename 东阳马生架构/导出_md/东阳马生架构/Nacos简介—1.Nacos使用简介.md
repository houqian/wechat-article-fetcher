...
![图片](assets/e5dd2314d87d.png)

如下是对应的Source code(zip)的目录结构：

![图片](assets/526abb363000.png)

3.Nacos 2.x服务端的数据库存储与日志存储

![图片](assets/58d13440ecba.png)

数据库初始化的脚本和日志存储的配置文件如下：

![图片](assets/4f900636f66c.png)
...
![图片](assets/68a6a16baa8c.png)

点击stock-service服务的详情进行查看，可以发现其IP和Port都登记好了。

![图片](assets/e6fbd786cfa1.png)
...
![图片](assets/6343def76923.png)

![图片](assets/640b2a1a1883.png)
