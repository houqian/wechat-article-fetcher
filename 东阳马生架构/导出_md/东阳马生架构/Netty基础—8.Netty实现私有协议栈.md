...
当服务端连续N次心跳超时后，需要主动关闭链路，同时还要清空该客户端的会话缓存信息，以保证可以重连成功。
...
当读取Packet数据包时，需要判断请求是握手请求还是握手响应。其中客户端处理握手响应，服务端处理握手请求。
