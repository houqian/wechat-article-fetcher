...
![图片](assets/b8bc9ee3e4cd.png)

#### 五.访问Sentinel Dashboard的控制台界面

输入http://localhost:8080即可，用户名密码都是小写sentinel。

![图片](assets/b6f04efb4436.png)
...
![图片](assets/25e07df9486d.png)

启动正常会输出如下日志：

![图片](assets/e5f4b619b5fb.png)
...
![图片](assets/2e9edd9a2a0a.png)

新增热点规则之后，就可以对热点规则进行编辑。在编辑框里，提供了高级选项进行进一步的选择。

![图片](assets/e1cd862dffed.png)
