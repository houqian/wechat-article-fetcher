...
> **公众号**: 阿里云开发者  
> **发布时间**: 2026-05-27 08:30  

![图片](assets/506ece6565c1.webp)
...
![图片](assets/976874e39ae8.png)场景| 名称| 触发条件
---|---|---
S1| 新模型上线| 单研发表，无基准表
...
编号| 模板名称| 校验目标| 必选
---|---|---|---
1| 总量对比| 基准表重算 vs 研发表汇总| 是
2| 数据质量检测| 空值率、零值率、维度合法性| 是
...
8| 历史趋势对比| 有历史数据时| 条件
9| 关联膨胀检测| 有 JOIN 操作时| 是
10| 日期维度关联校验| 有日期维度时| 是
...
NULL/默认值假设| `CASE WHEN x IS NOT NULL`、`COALESCE(x, '未知')` 跨维度复用
...
![图片](assets/be9062e39100.png)结论| 条件| 能否上线
---|---|---
...
![图片](assets/7f8431c6483b.png)能力模块| 提供的能力| 必需
---|---|---
表结构与元数据服务| 获取表 schema、节点代码、数据血缘、执行 SQL| 是
文档协作服务| 报告发布到协作文档（如企业文档平台、Wiki 等）| 是
