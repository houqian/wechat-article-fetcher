...
> **公众号**: 阿里云开发者  
> **发布时间**: 2025-08-27 08:30  

![图片](assets/b1ff77b98c9e.webp)
...
![图片](assets/389667746a68.jpg)(图源: https://blog.langchain.com/how-to-build-an-agent/）
...
Prompt 长这样：
  ...
  *   *   *   *   *   *   *   *   *   *   *   *   *   *   *   *   *   *   *
    ...
    **角色**: 你是一位顶级的云原生解决方案架构师...**任务**: 请对以下 `docker-compose.yml` 文件进行深度分析，并生成一份详尽的、结构化的Kubernetes迁移蓝图...
