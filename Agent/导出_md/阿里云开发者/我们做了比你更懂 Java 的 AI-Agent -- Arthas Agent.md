...
> **公众号**: 阿里云开发者  
> **发布时间**: 2026-03-10 08:30  

![图片](assets/c97366198dda.webp)
...
![图片](assets/b2cdab8d8fde.png)![图片](assets/5a0369508291.png)
...
![图片](assets/c370444944e8.png)![图片](assets/b90516aa7f12.png)
...
![图片](assets/193b5cf3c9e8.png)![图片](assets/b461b1d3e36e.png)
...
![图片](assets/e68b65104cc1.png)![图片](assets/b7070a66dbd8.png)
...
![图片](assets/647f3582d9e4.png)![图片](assets/a4e37d440eee.png)
...
示例：
  ...
  *   *   *   *   *
    ...
    # 只看第一个参数是某个类型的调用watch com.example.Service doSomething '{params, returnObj}' -c 'params[0].class.name == "com.example.User"' -n 5
    # 只看参数实现某接口watch com.example.Handler handle '{params}' -c 'params[0] instanceof @com.example.MyInterface@class' -n 5
...
![图片](assets/5dc57bfa00cd.png)![图片](assets/d2aebfcf2b8b.png)
...
![图片](assets/1527d68dfcaa.png)![图片](assets/7601a5d068ba.png)
