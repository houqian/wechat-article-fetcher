...
> **公众号**: 阿里云开发者  
> **发布时间**: 2026-01-08 08:30  

![图片](assets/ce19b435ebe7.webp)
...
![图片](assets/a8e4c1251347.jpg)![图片](assets/a84148d4184e.jpg)![图片](assets/a3b9c8d45f2e.jpg)

如上图所示，我们通过xml标签方式首先实现了在对话过程中支持复杂样式的渲染。

2\. 利用1day快速实现生成了一个用户可实时补充内容的UI。

![图片](assets/3ac9b9478f48.jpg)

### HITL交互作为一种工具

1\. 定义一种工具专门用来在需要参数补全的情况下被唤起

![图片](assets/499b6fcee2aa.jpg)
...
![图片](assets/2319d8bb8e82.jpg)

用户将内容输入完成后：

![图片](assets/ee7fea97844e.jpg)
